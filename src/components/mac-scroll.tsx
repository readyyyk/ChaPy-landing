...
export const MacbookScroll = (props: {
    src?: ImageProps['src'];
    showGradient?: boolean;
    title?: string | React.ReactNode;
    badge?: React.ReactNode;
}) => {
    const { src, showGradient, title, badge } = props;
    ...
    const scaleX = useTransform(
        scrollYProgress,
        [0, 0.3],
        [1.2, isMobile ? 1.2 : 1.9],
    );
    const scaleY = useTransform(
        scrollYProgress,
        [0, 0.3],
        [0.6, isMobile ? 1.2 : 1.9],
    );
    ...
    return (
        <div
            ref={ref}
            className="flex flex-col items-center py-0 md:py-80 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100 scale-50"
        >
            <motion.h2
                style={{
                ...
                className="dark:text-white text-neutral-800 text-5xl text-balance md:max-w-[60dvw] w-[200%] md:w-auto font-bold mb-20 text-center"
            >
                {title ?? (
                    <span>
...
export const Lid = (props: {
    ...
    const { scaleX, scaleY, rotate, translate, src } = props;
    return (
        <div className="relative [perspective:800px]">
            <div
                ...
                className="h-[12rem] w-[32rem] bg-[#010101] rounded-2xl p-2 relative shadow-[0_-6px_6px_1   px_#ffffff33]"
            >
                <div
                    style={{
                        boxShadow: '0px 2px 0px 2px var(--neutral-900) inset',
                    }}
                    className="absolute inset-0 bg-[#000] rounded-lg flex items-center justify-center"
                >
                    <Image
                        src={logo}
                        alt="ChaPy"
                        ...
                        style={{
                            transform:
                                'perspective(800px) rotateX(-25deg) translateZ(25deg)',
                            transformOrigin: 'bottom',
                            transformStyle: 'preserve-3d',
                            opacity: 0.4,
                        }}
